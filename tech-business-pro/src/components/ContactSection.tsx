            ...
            {/* <div className="bg-gradient-to-r from-primary-500 to-primary-600 text-black rounded-lg p-8 h-full">
              ...
              <div className="bg-white bg-opacity-10 rounded-lg p-6 mb-8">
                ...
                <p className="italic text-sm">
                  ...
                  request for IT Security Assessment, we recommend exploring our
                  tailored packages, including comprehensive vulnerability
                  scanning and penetration testing. A detailed overview has been
                  sent to your email for review.
                </p>
              </div>
